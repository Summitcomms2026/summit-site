 ...
 *
 * Variables (optional, passed via set_query_var before get_template_part):
...
<section class="subscribe-module section--padded" aria-labelledby="<?php echo esc_attr( $field_id . '-heading' ); ?>">
